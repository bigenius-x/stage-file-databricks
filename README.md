# biGENIUS Stage File Databricks Example

This is an example project for stage file Databricks for the biGENIUS-X application. This repository should give a quick introduction to stage modeling in Databricks.
